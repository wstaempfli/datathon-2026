...
| 2026-04-18 | realized_skewness | 0.0634 | 0.0150 | rejected  | Σrᵢ³/(n·RV¹·⁵), Amaya et al. (2015), bars 0-49. Pearson r=-0.0634 (p=4.5e-02), Spearman=-0.0549, MI=0.0150, n=1000. Gate1 pass, Gate3 pass (WD_pub/std=0.064, WD_priv/std=0.068). **Gate2 FAIL**: ablation lift=-0.406 Sharpe (with=2.777±0.654 vs without=3.183±0.635, 1/5 folds positive) — likely redundant with yang_zhang_vol, injects noise. |
